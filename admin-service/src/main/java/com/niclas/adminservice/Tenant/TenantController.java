...
public class TenantController {
    ...
    @GetMapping("/{tenantId}")
    public ResponseEntity<Tenant> getTenantById( @PathVariable(value = "tenantId") String tenantId ) throws TenantAliasNotFoundException {
    ...
    @PutMapping("/{tenantId}")
    public ResponseEntity<Tenant> updateTenant(@PathVariable(value = "tenantId") String tenantId, @RequestBody TenantRecord tenantRecord)
